...
class PowerRepository {
          ...
          case PowerCommands.queryDataSport_0x06:
            {
              ...
              _handleDeviceParams(value, deviceData);
              break;
            }
        }
        break;
  ...
  _handleDeviceParams(List<int> value, PowerDeviceData data) {
    LogUtils.d("返回的数据： ${Tools.getNiceHexArray(value)}");
    data.protectState = value[subCmdDataIndex_5];
    ...
    data.ropeBackState = value[subCmdDataIndex_5 + 7];
    data.ropeBackSpeed = Tools.getTwoByteByBigEndian(
      value[subCmdDataIndex_5 + 8],
      value[subCmdDataIndex_5 + 9],
    );
    bleDeviceDataController.add(BleDeviceDataMsg.dataQueryUpdate_0x06);
  }
  ...
  _handleSportData_33(List<int> value, PowerDeviceData data) {
    ...
    data.leftPower = Tools.getTwoByteByBigEndian(
  ...
  int _handleDeviceStatus(List<int> value, PowerDeviceData data) {
    ...
    bleDeviceDataController.add(BleDeviceDataMsg.dataQueryUpdate_0x02);
    return retCode;
  }
