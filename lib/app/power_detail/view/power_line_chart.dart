...
class PowerLineChart extends StatefulWidget {
  PowerLineChart({super.key, required this.list1, required this.list2});
  ...
  @override
  State<PowerLineChart> createState() => _PowerLineChartState();
}

class _PowerLineChartState extends State<PowerLineChart> {
  @override
