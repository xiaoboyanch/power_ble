...
class PowerWeightSingleChart extends StatefulWidget {
  PowerWeightSingleChart({super.key, required this.list1});
  ...
  @override
  State<PowerWeightSingleChart> createState() => _PowerWeightChartState();
}

class _PowerWeightChartState extends State<PowerWeightSingleChart> {
  @override
