...
class PowerGravityChart extends StatefulWidget {
  PowerGravityChart({super.key, required this.list1});
  ...
  @override
  State<PowerGravityChart> createState() => _PowerGravityChartState();
}

class _PowerGravityChartState extends State<PowerGravityChart> {
  @override
